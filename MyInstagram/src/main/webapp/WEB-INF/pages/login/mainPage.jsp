...
<body style="background: url('/resources/images/bg/darth-mainpage.jpg'); background-size: cover">
	<div class="form" id="mainPage">
		<span style="float: right; margin-top: 180px; margin-right: 280px;">
			<a href="${pageContext.request.contextPath}/?lang=en"><img src="/resources/images/flags/us.png"></a>
			<a href="${pageContext.request.contextPath}/?lang=ru"><img src="/resources/images/flags/ru.png"></a>
		</span>
