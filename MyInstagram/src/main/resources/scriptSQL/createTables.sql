...
(
  idLike LONG PRIMARY KEY NOT NULL AUTO_INCREMENT,
  idProfile VARCHAR(255) REFERENCES profile(idProfile) ON UPDATE CASCADE ON DELETE CASCADE,
  idPost VARCHAR(255) REFERENCES posts(idPost) ON UPDATE CASCADE ON DELETE CASCADE
);
